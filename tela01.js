...
function renderizarMeuQuizz() {
  ...
  const idsArray = JSON.parse(localStorage.getItem("ids"));
...
function adicionarQuizz(resposta) {
  console.log("vai adc quizz");
  listaQuizzUsuário1.push(resposta.data);
}
            ...
            <div class="conteudo-usuario1">
                <div class="usuario-quizz-completo1">
                    <div class="titulo-botao-completo1">
                        <h3>Seus Quizzes</h3>
                        <ion-icon class="criar-quizz-p1" name="add-circle" onclick="criarQuizz1()"></ion-icon>
                    </div>
